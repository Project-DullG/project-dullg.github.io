(function () {
  ...
  const candyKeepsHerPlace = {
    ...
    blocks: [
      ...
      { speaker: "캔디", text: "“아빠, 오늘 평가는 내가 통과했어. 이제 내 점수로 여기 있을 수 있어.”" }
    ]
  };
    ...
    "ryu-accused": {
      ...
      scenes: [
        ...
        danielWins,
        {
          ...
          tone: "future",
          blocks: [
            "류진환의 진술로 애쉬는 까마귀와 관계없다는 사실을 인정받았다. 애쉬는 왕실 요리사 자격을 지켰고, 동방 식재료의 독성과 조리법을 확인하는 일을 맡았다.",
      ...
      scenes: [
        {
          ...
          blocks: [
            ...
            "왕실 법정은 간첩 행위와 수도시설 중독 계획에 사형을 선고했다. 류진환은 마지막 진술에서 애쉬가 까마귀와 관계없다고 밝혔고, 사형은 그대로 집행됐다."
          ]
        },
        {
          label: "4년 뒤 · 수도의 식당가",
