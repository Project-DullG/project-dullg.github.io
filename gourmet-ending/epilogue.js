(function () {
  ...
  const escapedDaniel = {
    ...
    paragraphs: [
      ...
      "참고인 명단 아래쪽에 적힌 다니엘의 이름 옆에는 '국왕 시식 후 이상 반응 없음'이라는 문장만 남았습니다. 그 문장은 다니엘을 바로 묶지 못했습니다."
    ]
  };
  ...
  const ashFuture = {
    ...
    tone: "future",
    paragraphs: [
      "애쉬는 살인범으로 확정되지는 않았습니다. 대신 조살과 과육 사용, 떡볶이 조리 과정, 참가자 검수 누락을 조사받았습니다.",
      "애쉬의 자백은 살인 조서의 첫 줄이 되지 못했습니다. 조서에는 조살과 씨앗이 아니라 조살과 과육이라고 적혔고, 그 기록 때문에 살인 조서와 금지 식재료 조서가 따로 열렸습니다.",
      "애쉬가 지키려던 것은 자기 요리였지만, 왕실이 먼저 붙인 표식은 출입 정지였습니다."
    ]
  };
  ...
  const data = {
      ...
      cards: [
        {
          ...
          paragraphs: [
            ...
            "검은 단약이 남아 있었다는 사실은 살인 혐의를 약하게 했지만, 수도시설 쪽지는 류진환을 대회장 밖으로 나가게 두지 않았습니다."
          ]
        },
        escapedDaniel,
        ashFuture,
    ...
    candy: {
      title: "캔디의 주방 출입이 정지되자, 생일 편지는 증거 봉투에 남았습니다.",
      cards: [
        {
          label: "마지막 장면",
          name: "캔디",
          ...
          paragraphs: [
            ...
            "아버지에게 전하려던 축하 인사는 읽히지 않았습니다. 편지에서 먼저 읽힌 것은 애칭과 붉은 요리를 피하라는 부탁이었습니다."
          ]
        },
        escapedDaniel,
        ashFuture,
