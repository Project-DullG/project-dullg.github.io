(function () {
  ...
  const escapedDaniel = {
    ...
    tone: "danger",
    paragraphs: [
      "다니엘은 우승자가 되지 못했습니다. 그러나 살인범으로 발표되지도 않았습니다. 승강전은 무산됐고, 공보문 첫 장에는 금지 식재료와 왕궁 보안 문제가 먼저 올라갔습니다.",
  ...
  const ryuFuture = {
    ...
    tone: "future",
    paragraphs: [
      "류진환은 살인범으로 구속되지는 않았지만 왕궁 감찰을 피하지 못했습니다. 그는 정기 출석 조건을 받아들이고, 동쪽 시장 끝에 작은 국수대를 빌렸습니다.",
  ...
  const candyFuture = {
    ...
    tone: "future",
    paragraphs: [
      "캔디는 왕실 주방 출입 정지를 받았습니다. 아버지 이름으로 열리던 문은 닫혔고, 그녀는 성 밖 제과 공방에서 생일 케이크 주문부터 다시 받았습니다.",
  ...
  const data = {
    ...
    ash: {
      title: "애쉬가 별실로 옮겨진 뒤, 세 사람의 처분이 갈라졌습니다.",
      cards: [
        {
          label: "마지막 장면",
          name: "애쉬",
      ...
      cards: [
        {
          ...
          paragraphs: [
            ...
            "경비대가 그를 데려갈 때, 그는 애쉬 쪽을 보지 않았습니다. 고개를 돌리는 순간 그녀까지 같은 질문지에 묶일 것을 알았기 때문입니다. 조사실 문이 닫힐 때까지 그는 \"살인은 하지 않았다\"는 말을 끝내 꺼내지 못했습니다."
          ]
        },
        escapedDaniel,
        ashFuture,
    ...
    candy: {
      title: "캔디의 주방 출입이 정지된 뒤, 세 사람의 조사는 다른 방향으로 이어졌습니다.",
      cards: [
        {
          label: "마지막 장면",
          name: "캔디",
